<div class="fixed bg-slate-900 w-screen h-screen bg-opacity-50 z-[999999]" id="alert">
    <div class="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] bg-yellow-100 border-t-4 border-yellow-500 rounded-b text-yellow-900 px-5 py-10 shadow-md"
        role="alert">
        <div class="flex">
