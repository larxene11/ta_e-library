    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ route('manage_siswa.add') }}" class="btn btn-primary shadow-md mr-2">Tambah Siswa</a>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu w-40">
                        <ul class="dropdown-content">
                            <li>
                                <a href="{{ route('exportPDF.siswa') }}" class="dropdown-item"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Export to PDF </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <form action="{{ route('manage_siswa.all') }}" method="get">
                ...
                <table class="table table-report -mt-2">
                    ...
                    <tbody>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">{{ $item->jurusan_jabatan }}</td>
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <input type="hidden" id="delete_route_{{ $index }}"
                                        value="{{ route('manage_user.delete', ['user' => $item]) }}">
                                </div>
                            </td>
                        </tr>
                    @empty
