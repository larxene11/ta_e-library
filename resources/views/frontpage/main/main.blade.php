    ...
    <form action="{{  }}" method="GET">
        <div class="flex md:px-80 md:pt-3 pt-1">
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                ...
                <li>
                    <button type="button" name="category" class="inline-flex w-full px-4 py-2 hover:bg-gray-100 ">{{ $item->name }}</button>
                </li>
                @endforeach
                </ul>
            </div>
            <div class="relative w-full">
                <input type="text" name="keyword" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300" placeholder="Masukan kata kunci yang ingin dicari" required>
