...
@section('body')
    ...
    <div class="lg:h-full w-full md:h-[500px] h-[500px] relative">
        <img src="{{ asset('dist/images/book1.jpg') }}" alt="" class="object-cover object-center w-full h-80">
    ...
    {{-- BANNER --}}
    {{-- Tombol Search --}}
    <div class="flex justify-center pb-10 mb-8">
        ...
        <button class="bg-slate-500 text-white px-4 py-2 rounded-r-md">Cari</button>
    </div>
@endsection